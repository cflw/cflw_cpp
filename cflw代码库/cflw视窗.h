...
typedef HWND t窗口句柄, th窗口;	//行:208
typedef HHOOK t挂钩句柄, th挂钩;	//行:209
typedef HBITMAP t位图句柄, th位图;	//行:260
typedef HBRUSH t画刷句柄, th画刷;	//行:261
typedef HFONT t字体句柄, th字体;	//行:273
typedef HICON t图标句柄, th图标;	//行:275
typedef HMENU t菜单句柄, th菜单;	//行:277
typedef HINSTANCE t实例句柄, th实例;//行:280
typedef HPEN t笔句柄, th笔;	//行:284
typedef HCURSOR t光标句柄, th光标;	//行:308
...
// winerror.h
//--------------------------------------------------------------------------------
inline bool fw成功(const HRESULT &p结果) {
	return p结果 >= 0;
};	//行:23775
inline bool fw失败(const HRESULT &p结果) {
	return p结果 < 0;
};	//行:23775
//--------------------------------------------------------------------------------
// 使用类/结构
