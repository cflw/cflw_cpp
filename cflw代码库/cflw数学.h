...
template<typename t返回, typename...t参数> t返回 f算术平均(t参数 &&...);
template<typename t返回, typename...t参数> t返回 f几何平均(t参数 &&...);
template<typename t返回, typename...t参数> t返回 f绝对值最大值(t参数 &&...);	//计算出绝对值最大值,返回原值
//==============================================================================
// 基本几何函数
//==============================================================================
//特别角度
