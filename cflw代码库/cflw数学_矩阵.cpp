...
S矩阵4 S矩阵4::fc镜面反射(const S平面3 &a平面) {
	S矩阵4 v;
...
S矩阵4 S矩阵4::fc阴影(const S平面3 &a平面, const S向量4 &a光) {
	//l.w==0是平行光，l.w==1是点光
	S矩阵4 v;
	const S平面3 n = a平面.fg归一();	//a,b,c可作为法线的x,y,z用
	const S向量3 l = a光.ft向量3();
	const float nl = n.fg法线().f点乘(l);
	const float nld = nl - n.d * a光.w;
	v.m值[0][0] = nld-n.a*l.x;	v.m值[1][0] = -l.y*n.a;		v.m值[2][0] = -l.z*n.a;		v.m值[3][0] = -a光.w*n.a;
	v.m值[0][1] = -l.x*n.b;		v.m值[1][1] = nld-l.y*n.b;	v.m值[2][1] = -l.z*n.b;		v.m值[3][1] = -a光.w*n.b;
	v.m值[0][2] = -l.x*n.c;		v.m值[1][2] = -l.y*n.c;		v.m值[2][2] = nld-l.z*n.c;	v.m值[3][2] = -a光.w*n.c;
	v.m值[0][3] = -l.x*n.d;		v.m值[1][3] = -l.y*n.d;		v.m值[2][3] = -l.z*n.d;		v.m值[3][3] = nl;
	return v;
}
}	//namespace cflw::数学